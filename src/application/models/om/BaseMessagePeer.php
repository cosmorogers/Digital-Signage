...
abstract class BaseMessagePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'CreatedAt', 'Title', 'Author', 'Message', 'Start', 'End', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'createdAt', 'title', 'author', 'message', 'start', 'end', ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID, MessagePeer::USER_ID, MessagePeer::CREATED_AT, MessagePeer::TITLE, MessagePeer::AUTHOR, MessagePeer::MESSAGE, MessagePeer::START, MessagePeer::END, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'CREATED_AT', 'TITLE', 'AUTHOR', 'MESSAGE', 'START', 'END', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'created_at', 'title', 'author', 'message', 'start', 'end', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'CreatedAt' => 2, 'Title' => 3, 'Author' => 4, 'Message' => 5, 'Start' => 6, 'End' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'createdAt' => 2, 'title' => 3, 'author' => 4, 'message' => 5, 'start' => 6, 'end' => 7, ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID => 0, MessagePeer::USER_ID => 1, MessagePeer::CREATED_AT => 2, MessagePeer::TITLE => 3, MessagePeer::AUTHOR => 4, MessagePeer::MESSAGE => 5, MessagePeer::START => 6, MessagePeer::END => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'CREATED_AT' => 2, 'TITLE' => 3, 'AUTHOR' => 4, 'MESSAGE' => 5, 'START' => 6, 'END' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'created_at' => 2, 'title' => 3, 'author' => 4, 'message' => 5, 'start' => 6, 'end' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MessagePeer::MESSAGE);
            $criteria->addSelectColumn(MessagePeer::START);
            $criteria->addSelectColumn(MessagePeer::END);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(MessagePeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::TITLE))
            $columns[MessagePeer::TITLE] = $obj->getTitle();

        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::AUTHOR))
            $columns[MessagePeer::AUTHOR] = $obj->getAuthor();

        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::MESSAGE))
            $columns[MessagePeer::MESSAGE] = $obj->getMessage();

        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::START))
            $columns[MessagePeer::START] = $obj->getStart();

        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::END))
            $columns[MessagePeer::END] = $obj->getEnd();
