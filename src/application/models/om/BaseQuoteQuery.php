 ...
 *
 *
 * @method QuoteQuery orderById($order = Criteria::ASC) Order by the id column
 * @method QuoteQuery orderByQuote($order = Criteria::ASC) Order by the quote column
 *
 * @method QuoteQuery groupById() Group by the id column
 * @method QuoteQuery groupByQuote() Group by the quote column
 *
 ...
 *
 * @method Quote findOneByQuote(string $quote) Return the first Quote filtered by the quote column
 *
 * @method array findById(int $id) Return Quote objects filtered by the id column
 * @method array findByQuote(string $quote) Return Quote objects filtered by the quote column
 *
...
abstract class BaseQuoteQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `quote` FROM `quote` WHERE `id` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(QuotePeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(QuotePeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(QuotePeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(QuotePeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(QuotePeer::ID, $id, $comparison);
    }
    ...
    public function filterByQuote($quote = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(QuotePeer::QUOTE, $quote, $comparison);
    }
    ...
    {
        if ($quote) {
            $this->addUsingAlias(QuotePeer::ID, $quote->getId(), Criteria::NOT_EQUAL);
        }
