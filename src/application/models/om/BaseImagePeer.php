...
abstract class BaseImagePeer
{
    ...
    /**
     * An identity map to hold any loaded instances of Image objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Filename', 'Date', 'UserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'filename', 'date', 'userId', ),
        BasePeer::TYPE_COLNAME => array (ImagePeer::ID, ImagePeer::NAME, ImagePeer::FILENAME, ImagePeer::DATE, ImagePeer::USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'FILENAME', 'DATE', 'USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'filename', 'date', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Filename' => 2, 'Date' => 3, 'UserId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'filename' => 2, 'date' => 3, 'userId' => 4, ),
        BasePeer::TYPE_COLNAME => array (ImagePeer::ID => 0, ImagePeer::NAME => 1, ImagePeer::FILENAME => 2, ImagePeer::DATE => 3, ImagePeer::USER_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'FILENAME' => 2, 'DATE' => 3, 'USER_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'filename' => 2, 'date' => 3, 'user_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ImagePeer::FILENAME);
            $criteria->addSelectColumn(ImagePeer::DATE);
