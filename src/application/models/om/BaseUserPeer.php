...
abstract class BaseUserPeer
{
    ...
    /** the column name for the use_ad field */
    const USE_AD = 'user.use_ad';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'UseAd', 'Password', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'useAd', 'password', 'name', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::USE_AD, UserPeer::PASSWORD, UserPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'USE_AD', 'PASSWORD', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'use_ad', 'password', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'UseAd' => 2, 'Password' => 3, 'Name' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'useAd' => 2, 'password' => 3, 'name' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::USE_AD => 2, UserPeer::PASSWORD => 3, UserPeer::NAME => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'USE_AD' => 2, 'PASSWORD' => 3, 'NAME' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'use_ad' => 2, 'password' => 3, 'name' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
