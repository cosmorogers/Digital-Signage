...
abstract class BaseWidgetPeer
{
    ...
    {
        $toNames = WidgetPeer::getFieldNames($toType);
        $key = isset(WidgetPeer::$fieldKeys[$fromType][$name]) ? WidgetPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(WidgetPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, WidgetPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return WidgetPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(WidgetPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(WidgetPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(WidgetPeer::$instances[$key])) {
                return WidgetPeer::$instances[$key];
            }
        }
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Widget object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = WidgetPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = WidgetPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getDatabaseMap(WidgetPeer::DATABASE_NAME)->getTable(WidgetPeer::TABLE_NAME);
    }
    ...
    /**
     * Performs an INSERT on the database, given a Widget or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a Widget or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(WidgetPeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(WidgetPeer::TABLE_NAME, $con, WidgetPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a Widget or Criteria object OR a primary key value.
     *
