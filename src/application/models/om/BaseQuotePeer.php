...
abstract class BaseQuotePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Quote', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'quote', ),
        BasePeer::TYPE_COLNAME => array (QuotePeer::ID, QuotePeer::QUOTE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'QUOTE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'quote', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Quote' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'quote' => 1, ),
        BasePeer::TYPE_COLNAME => array (QuotePeer::ID => 0, QuotePeer::QUOTE => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'QUOTE' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'quote' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(QuotePeer::QUOTE);
        } else {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(QuotePeer::ID);
            if ($value) {
                $selectCriteria->add(QuotePeer::ID, $value, $comparison);
            } else {
