...
abstract class BaseQuote extends BaseObject implements Persistent
{
    ...
    public function setQuote($v)
    {
        ...
        if ($this->quote !== $v) {
            $this->quote = $v;
            $this->modifiedColumns[] = QuotePeer::QUOTE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = QuotePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(QuotePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(QuotePeer::QUOTE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuotePeer::QUOTE)) $criteria->add(QuotePeer::QUOTE, $this->quote);
