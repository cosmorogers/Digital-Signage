 ...
 * @method TemplateQuery orderByWidth($order = Criteria::ASC) Order by the width column
 * @method TemplateQuery orderByHeight($order = Criteria::ASC) Order by the height column
 *
 * @method TemplateQuery groupById() Group by the id column
 * @method TemplateQuery groupByName() Group by the name column
 * @method TemplateQuery groupByWidth() Group by the width column
 * @method TemplateQuery groupByHeight() Group by the height column
 *
 ...
 * @method Template findOneByWidth(int $width) Return the first Template filtered by the width column
 * @method Template findOneByHeight(int $height) Return the first Template filtered by the height column
 *
 ...
 * @method array findByWidth(int $width) Return Template objects filtered by the width column
 * @method array findByHeight(int $height) Return Template objects filtered by the height column
 *
...
abstract class BaseTemplateQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'signage', $modelName = 'Template', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `width`, `height` FROM `template` WHERE `id` = :p0';
        try {
    ...
    public function filterByWidth($width = null, $comparison = null)
    {
        if (is_array($width)) {
            $useMinMax = false;
            if (isset($width['min'])) {
                $this->addUsingAlias(TemplatePeer::WIDTH, $width['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($width['max'])) {
                $this->addUsingAlias(TemplatePeer::WIDTH, $width['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TemplatePeer::WIDTH, $width, $comparison);
    }
    ...
    public function filterByHeight($height = null, $comparison = null)
    {
        if (is_array($height)) {
            $useMinMax = false;
            if (isset($height['min'])) {
                $this->addUsingAlias(TemplatePeer::HEIGHT, $height['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($height['max'])) {
                $this->addUsingAlias(TemplatePeer::HEIGHT, $height['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TemplatePeer::HEIGHT, $height, $comparison);
    }
