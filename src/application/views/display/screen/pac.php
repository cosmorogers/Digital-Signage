...
<html lang="en">
  ...
  <body>
    <div class="navbar navbar-inverse">
          ...
          <h2 style="color:#FFF; text-align:center; padding-right:37px;">Performing Arts Centre</h2>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span3">
		      <div class="hero-unit" id="messageOuter">
        ...
        <div class="span9">
		      <div id="slideshow">
			      <?php
			      $slideshow = SlideshowQuery::create()->findOneById(4);
