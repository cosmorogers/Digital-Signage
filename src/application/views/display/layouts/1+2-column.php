...
$layoutDescription = array(
    'name' => "1 + 2 Column",
    'desc' => "1 column at the top and 2 at the bottom",
    'containers' => array(
        array(
            'name' => 'top',
            'desc' => 'Appears across the top'
        ),
        array(
            'name' => 'left',
            'desc' => 'Appears in the left column'
        ),
        array(
            'name' => 'right',
            'desc' => 'Appears in the right column'
        )
    ),
    'has_title' => true,
);
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <?php echo (!is_null($t) ? $t->getWidgetsInContainer('top', $screen) : ''); ?>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span3">
            <?php echo (!is_null($t) ? $t->getWidgetsInContainer('left', $screen) : ''); ?>
        </div>

        <div class="span9">
            <?php echo (!is_null($t) ? $t->getWidgetsInContainer('right', $screen) : ''); ?>
        </div>
    </div>
</div>
